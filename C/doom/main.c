...
// The command to run the project is gcc main.c -lGL -lGLU -lglut && ./a.out 
...
#define pixelScale 17/res                    //OpenGL pixel scale
...
void draw3D()
{
 int wx[4], wy[4], wz[4]; const float CS=M.cos[P.a], SN =M.sin[P.a];
 ...
 wx[0] *= 200/wy[0]+SW2; wy[0] = wz[0]*200/wy[0]+SH2;
 wx[1] *= 200/wy[1]+SW2; wy[1] = wz[1]*200/wy[1]+SH2;
...
{       
  ...
  for(x=0; x <360; x++){
    M.cos[x] = cos(x/180*PI);
    M.sin[x] = sin(x/180*PI);
  }
